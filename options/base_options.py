...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--load_size', type=int, default=512, help='scale images to this size')#opt.load_size: 加载图像时的目标大小（用于 resize）
        parser.add_argument('--crop_size', type=int, default=512, help='then crop to this size')#opt.crop_size: 裁剪图像时的目标大小
        ...
        parser.add_argument('--CACM', type=float, default=1.0 )
        parser.add_argument('--LDAM', type=float, default=1.0 )
        parser.add_argument('--pixelwpiexl', action='store_true', help='pixelwpiexl')
        parser.add_argument('--patchwpatch', action='store_true', help='patchwpatch')
        parser.add_argument('--GBCLM', type=float, default=1.0 )
        parser.add_argument('--conv_type', type=str, default='tag', choices=['none', 'tag', 'gcn', 'gat'], help='chooses which graph conv layer to use in PatchGCL.')
        ...
        #parser.add_argument('--seed', type=int, default=2025, help='the seed ')
